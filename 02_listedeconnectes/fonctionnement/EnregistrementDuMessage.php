...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $json_file = file_get_contents('../../bibliotheque/03_discution/historiqueS_messages.json');
    ...
    file_put_contents('../../bibliotheque/03_discution/historiqueS_messages.json', $updated_json);
