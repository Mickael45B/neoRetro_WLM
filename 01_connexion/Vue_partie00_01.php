...
<!-- PARTIE 01 ==> --------------------------------------------------------------------------------------------------------------------------------------------------- FENETRE DE CONNEXION ==> -->
      ...
      <div id="P1_Cadreinterieur" class="P1_app" data-vide="" value="" name="" style="">
        ...
        <div id="P1_cadreCorpConnexion" class="P1_app__frame" data-vide="" value="" name="" style="">
          ...
          <div id="P1_zoneDeSaisie" class="P1_app__section P1_app__login centre_centre" data-vide="" value="" name="" style="">
            <div id="P1_cadreInterieurZoneSaisie" class="P1_app__login-inner" data-vide="" value="" name="" style="">
              ...
              <span id="blocSaisiePseudo" class="P1_Saisie centre_centre" data-vide="" value="" name="" style="">
                <span id="" class="ensembleSaisieConfirmation centre_centre" data-vide="" value="" name="" style="">
                  <input id="saisiePseudo" class="P1_app__login--pseudo zoneDeSaisie" data-vide="" value="" name="P1_app__login--pseudo" style="" type="text" placeholder="votre Pseudo ici">
              ...
              <span id="blocSaisieMail" class="P1_Saisie centre_centre" data-vide="" value="" name="" style="" >
                <span id="" class="ensembleSaisieConfirmation centre_centre" data-vide="" value="" name="" style="">
                  <input id="saisieMail" class="P1_app__login--email zoneDeSaisie" data-vide="" value="" name="P1_app__login--email" style="" type="text" placeholder="votre mail ici">
              ...
              <span id="blocSaisieMDP" class="P1_Saisie centre_centre" data-vide="" value="" name="" style="">
                <span id="" class="ensembleSaisieConfirmation centre_centre" data-vide="" value="" name="" style="">
                  <input id="saisieMDP" class="P1_app__login--pass zoneDeSaisie" data-vide="" value="" name="P1_app__login--pass" style="" type="password"  placeholder="votre mot de passe ici">
                  <span id="" class="" data-vide="" value="" name="" style="">
              ...
              <span id="blocSaisieConfirmMDP" class="P1_Saisie centre_centre" data-vide="" value="" name="" style="" >
                <span id="" class="ensembleSaisieConfirmation centre_centre" data-vide="" value="" name="" style="">
                  <input id="saisieConfirmMDP" class="P1_app__login--confirmPass zoneDeSaisie" data-vide="" value="" name="P1_app__login--confirmPass" style="" type="password"  placeholder="confirmer votre mot de passe">
                  <span id="" class="" data-vide="" value="" name="" style="">
              ...
              <span id="blocSaisieStatut" class="P1_Saisie P1_app__login-inner--select centre_centre" data-vide="" value="" name="" style="">
                <span id="" class=" zoneDeSaisie saisieListeDeroulante" data-vide="" value="" name="" style="">
                ...
                <span id="bloccheckMDP_Perdu" class=" P1_Saisie P1_app__login-inner--checkbox centre_centre" data-vide="" value="" name="" style="">
                  <span id="" class="ensembleSaisieConfirmation" data-vide="" value="" name="" style="">
                    <span id="" class="check" data-vide="" value="" name="" style="">
                      ...
                      <span id="" class="" data-vide="" value="" name="" style="" >mot de passe oublié ou renouvellement de mot de passe</span>
                      <span id="codeValidation" class="" data-vide="" value="" name="" style="" >code</span>
                    </span>
                  </span>
                </span>

                <div id="conditionGeneralU" class="" data-vide="" value="" name="" style="">
                      <span id="" class="" data-vide="" value="" name="" style=""><input id="" class="boutoncheck" data-vide="" value="" name="" style="" type="checkbox" required> </span>
                      <span id="" class="" data-vide="" value="" name="" style=""> en cochant cette case vous acceptez les <a href="#">conditions générale d'utilisation</a></span>
                </div>
              </div>

              <!-- icones de securite : les icones se melange aleatoirement, sauf le dernier " ... " -->
              <div id="lesGlyphesEtLeTexte">
                ...
                <div id="GlyphAChoisir" class="" data-vide="" value="" name="" style="display:flex; justify-content:center;" >
                  <span id="glyphASelectione" class="" data-vide="" value=<?= $valeurAleatoire; ?> name="" style=""><?= " cliquer sur : <b>".$valeurAleatoire.'</b> si vous ne voyez pas l\'icone correspondante, cliquez sur "..."'; ?></span>
                </div>
              </div>
              ...
              <span id="P1_app__login-button" class="P1_app__login-button centre_centre" data-vide="" value="" name="" style="">
                <button data-vide="" value="" name="" data-vide="" value="" name="" style="" type="submit" >
                  <span id="texteDeConnexion" class="" data-vide="" value="" name="" style="width: 60px;"> 
                    Bienvenue
                  </span>
                </button>
              </span>
          ...
          <div id="P1_piedDePartie" class="P1_Saisie P1_app__section P1_app__footer" data-vide="" value="" name="" style="">
            <div id="piedDePage" class="P1_app__footer--credits" data-vide="" value="" name="" style="">
              <div>mentions legales
                  <div style="display:none">identité
                      ==>INFOS FICTIVES
                  </div>
                  <div style="display:none">contact
                      <div>newletter</div>
                      <div>mail</div>
                      <div>suivez-nous
                  ...
                  <div style="display:none">site
                      <div>copiryght(s)</div>
                      <div>avis</div>
                  </div>
                  <div style="display:none">politiques
                      <div>CGU</div>
                      <div>cookies</div>
                      <div>
                          <a href="https://eur-lex.europa.eu/FR/legal-content/summary/general-data-protection-regulation-gdpr.html">regles RGPD</a>
                      </div>
                  </div>
              </div>          
            </div>
  ...
  <!-- PARTIE 01.02 ==> ---------------------------------------------------------------------------------------------------------------------------------------------------- NOTIFICATION ==> -->
    <div id="P1_app__notification" class="P1_app__notification" data-vide="" value="" name="" style="">
