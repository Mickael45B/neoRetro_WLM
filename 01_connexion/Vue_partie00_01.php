                ...
                <div id="P1_cadreInterieurZoneSaisie" class="P1_app__login-inner" data-vide="" value="" name="">
                  ...
                  <span id="blocSaisiePseudo" class="P1_Saisie centre_centre" data-vide="" value="" name="">
                    ...
                    <span id="" class="ensembleSaisieConfirmation" data-vide="" value="" name="" style="">
                      ...
                      <button id="" class="" data-vide="" value="" name="">
                        <img id="soumettrePseudo" class="P1_validerSaisie" data-vide="" value="" name="" style="" src="01_connexion/fleche-droite.png">
                      </button>
                    </span>
                  </span>
                  ...
                  <span id="blocSaisieMail" class="P1_Saisie centre_centre">
                    ...
                    <span id="" class="ensembleSaisieConfirmation" data-vide="" value="" name="" style="">
                      ...
                      <button id="" class="" data-vide="" value="" name="">
                        <img id="soumettreMail" class="P1_validerSaisie" data-vide="" value="" name="" style="" src="01_connexion/fleche-droite.png">
                      </button>
                    </span>
                  </span>
                  ...
                  <span id="blocSaisieMDP" class="P1_Saisie centre_centre" data-vide="" value="" name="">
                    ...
                    <span id="" class="ensembleSaisieConfirmation" data-vide="" value="" name="" style="">
                      ...
                      <button id="" class="" data-vide="" value="" name="">
                        <img id="soumettreMDP" class="P1_validerSaisie" data-vide="" value="" name="" style="" src="01_connexion/fleche-droite.png">
                      </button>
                    </span>
                  </span>
                  ...
                  <span id="blocSaisieConfirmMDP" class="P1_Saisie centre_centre" data-vide="" value="" name="" >
                    ...
                    <span id="" class="ensembleSaisieConfirmation" data-vide="" value="" name="" style="">
                      ...
                      <button id="" class="" data-vide="" value="" name="">
                        <img id="soumettreConfirmMDP" class="P1_validerSaisie" data-vide="" value="" name="" style="" src="01_connexion/fleche-droite.png">
                      </button>
                    </span>
                  </span>
                  ...
                  <span id="P1_app__login-button" class="P1_app__login-button centre_centre">
                  <button data-vide="" value="" name="" type="submit" ><span style="width: 60px;"> Bienvenue</span></button>
                  </span>
                </div>
              </div>
