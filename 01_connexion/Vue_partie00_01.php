          ...
          <div id="" class="P1_app" data-vide="" value="" name="">
            ...
            <div id="" class="P1_app__frame" data-vide="" value="" name="">
              <div id="" class="P1_app__section P1_app__profile" data-vide="" value="" name="">
                <img id="" class="P1_app__profile--image" data-vide="" value="" name="" style="" src="00_general/avatars/msn.png" alt="">            
              </div>

              <div id="" class="P1_app__section P1_app__login" data-vide="" value="" name="">
                <div id="" class="P1_app__login-inner" data-vide="" value="" name="">

                  <span id="" class="P1_Saisie" data-vide="" value="" name="">
                    <label id="" class="" data-vide="" value="" name="" for="P1_app__login--pseudo">Pseudo:</label>
                      ...
                      <img id="soumettrePseudo" class="" data-vide="" value="" name="" style="height:14px;" src="01_connexion/fleche-droite.png">
                    </button>
                  </span>

                  <div id="blocSaisieMail" class="P1_Saisie" data-vide="" value="" name="">
                  ...
                  <div id="blocSaisieMDP" class="P1_Saisie" data-vide="" value="" name="">
                  ...
                  <div id="blocSaisieConfirmMDP" class="P1_Saisie" data-vide="" value="" name="" >
                  ...
                  <div id="" class="P1_Saisie P1_app__login-inner--checkbox" data-vide="" value="" name="">
                  ...
                  <div id="bocDeGlypsDeSecurite" class="" data-vide="" value="" name="">
                    <?php
                      ...
                      /*echo '<a id="iconeSecustylo" class="iconeSecu" data-vide="" value="stylo" name="" href="#">stylo</a>';
                      echo '<a id="iconeSecuchien" class="iconeSecu" data-vide="" value="chien" name="" href="#">chien</a>';
                      echo '<a id="iconeSecuchat" class="iconeSecu" data-vide="" value="chat" name="" href="#">chat</a>';*/
...
/*
if (in_array($valeurSaisie, $combinaison)) {
    echo "Réussi";
} else {
    echo "Échec";
}
