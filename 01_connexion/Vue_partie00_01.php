    ...
    <!-- PARTIE 00 ==> ------------------------------------------------------------------------------------------------------------------------------------------------------ LOGO DE DEMMARAGE ==> -->
      <div id="P0_logoDeDemarage" class="" data-...="" value="" name="">
        <a id="" class="" data-...="" value="" name="" href="#">
          <img id="P0_logoDeDemarageButton" class="" data-...="" value="" name="" src="../00_general/icones/fixe/iconeDemarage.png" alt="demarage">
        </a>
      </div>
    <!-- <== PARTIE 00 ------------------------------------------------------------------------------------------------------------------------------------------------------ LOGO DE DEMMARAGE ==> -->
                ...
                <div id="P1_cadreInterieurZoneSaisie" class="P1_app__login-inner" data-vide="" value="" name="" style="">
                  ...
                  <span id="blocSaisieMail" class="P1_Saisie centre_centre" data-vide="" value="" name="" style="" >
                    ...
                    <span id="" class="ensembleSaisieConfirmation" data-vide="" value="" name="" style="">
                      ...
                      <button id="" class="" data-vide="" value="" name="" style="">
                  ...
                  <span id="blocSaisieMDP" class="P1_Saisie centre_centre" data-vide="" value="" name="" style="">
                    <label id="" class="" data-vide="" value="" name="" style="" for="P1_app__login--pass">Password:</label>
                    <span id="" class="ensembleSaisieConfirmation" data-vide="" value="" name="" style="">
                  ...
                  <div id="bocDeGlypsDeSecurite" class="centre_centre" data-vide="" value="" name="" style="">
                    <?php
                      ...
                      echo '<a id="iconeSecu" class="iconeSecu" data-vide="" value="autre" name="" href="#"><img id="iconeSecuDivers" class="" data-vide="" value="" name="" src="bibliotheque/01_connexion/iconesConnexion/dots-horizontal-rounded-regular-24.png" alt="..."></a>';
                  ...
                  <div id="GlyphAChoisir" class="centre_centre" data-vide="" value="" name="" style="" >cliquer sur : 
                    <!-- <span id="glyphASelectione" class="" data-vide="" value="" name="">
                      
                    </span> -->
                    <span id="glyphASelectione" class="" data-vide="" value="" name="" style=""><?php echo $valeurAleatoire;?></span>
                    <div>
...
<?php
/*
 echo date('d-m-Y H:i:s', strtotime('+1 hour'))."<br>". date('d-m-Y H:i:s'); 
 */
/*
 $date = time();
...
$finDeValidite=1709144156514;
 $timestamp = intval($finDeValidite / 1000); // Convertir le timestamp en secondes
 $dateFinValidite = date("d/m/Y", $timestamp); // Formater la date et l'heure
 $heureFinValidite = date("H:i", $timestamp); // Formater la date et l'heure
 


echo $heureFinValidite.' coucou';
 ?>
