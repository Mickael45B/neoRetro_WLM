...
?>
              ...
              <div class="P3_container">
                <div class="P3_msn-messenger-history-chat">
                  <div class="P3_container">
                    ...
                    <div id="historiqueMess" style="justify-content:left; ">
    ...
    <script src="../03_discution/fonctionnement/script_historiqueMessages.js"></script>
    <script src="../03_discution/fonctionnement/emoji-en-US.json"></script>
    <script src="../03_discution/fonctionnement/API_GIF.js"></script>
    <script src="../03_discution/fonctionnement/api-chuckNorris.js"></script>
