<?php // partie 2
  ...
  */
        ...
        */
      ?>  
      <div id="" class="ListeDesContacts toggleable" data-vide="" value="" name="" style="">
            ...
            <div id="P2_contacts" class="P2_mainwindow" data-vide="" value="" name="" >
              ...
              <!-- PARTIE 03 ------------------------------------------------------------------------------------------------------------------------------------------------------------- CORP ==> -->
                <!-- PARTIE 03 01 --------------------------------------------------------------------------------------------------------------------------------------- RECHERCHE DE CONTACTS ==> -->
                  ...
                  <input id="P2_changePseudo" class="" data-vide="" value="" name="" type="text" placeholder="changer de pseudo"><!-- changer pseudo -->
                  <button id="" class="P2_searchbar-btn" data-vide="" value="" name="" style="background:url(../bibliotheque/02_listedeconnectes/icones/1131.png) no-repeat center;"></button><!-- boutton validation -->
              ...
              <!-- PARTIE 04 ----------------------------------------------------------------------------------------------------------------------------------------------------- PIED DE PAGE ==> -->
                  <div id="P2_footer" class="" data-vide="" value="" name="" ><!-- pied de page -->
                      <span id="" class="" data-vide="" value="" name="" style="color: #9bb3d4;">vous etes connecté en Administrateur</span>
