...
<html>
	...
	<head>
        ...
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.js"></script> <!-- https://code.jquery.com/jquery-3.6.0.min.js -->
...
exit;
    ...
    <!-- PARTIE 02 ==> ----------------------------------------------------------------------------------------------------------------------------------------------------- LISTE DE CONNECTES ==> -->
       <!-- TRONC COMMUN -->
        <?php include '02_listedeconnectes/Vue_partie02.php'; ?>   
    <!-- <== PARTIE 02 ----------------------------------------------------------------------------------------------------------------------------------------------------- <== LISTE DE CONNECTES -->
