...
function updateCustomProperty() {
  document.documentElement.style.setProperty('--largueur_fenetre', window.innerWidth + 'px');
      document.documentElement.style.setProperty('--hauteur_fenetre', window.innerHeight + 'px');}
