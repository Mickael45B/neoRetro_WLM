...
document.addEventListener('DOMContentLoaded', function () {
    ...
    for (let i = 0; i < 5; i++) {
      for (let j = 0; j < 6; j++) {
        ...
        cell.addEventListener('click', function () {
          ...
          const imageLink = prompt('Veuillez saisir le lien de l\'image GIF:');
  ...
  function sauvegarderMessage(messageObjet) {
...
<style>
  ...
  .cell {
    ...
    cursor: pointer;
      ...
      </div> <img src="Poweredby_100px-White_VertLogo.png" alt="logo_Giphy"> 
<!-- TEST -->
      <input type="text" id="searchInput" placeholder="Rechercher un GIF">
    <button onclick="searchGif()">Rechercher</button>
